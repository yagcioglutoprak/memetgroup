...
const services = [
  {
    id: 1,
    title: 'Rénovation',
    description: 'Transformation complète d\'espaces commerciaux et résidentiels avec expertise et précision.',
    icon: (
    ...
    features: ['Démolition', 'Construction', 'Peinture', 'Finition']
  },
  {
    id: 2,
    title: 'Aménagement de magasins',
    description: 'Conception et installation d\'espaces commerciaux fonctionnels et visuellement attrayants.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="currentColor" className="w-10 h-10">
    ...
    image: '/images/retail_layout.png',
    features: ['Conception', 'Fabrication', 'Installation', 'Signalétique']
  },
  {
    id: 3,
    title: 'Plomberie',
    description: 'Installation et maintenance de systèmes de plomberie pour tout type de bâtiment.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="currentColor" className="w-10 h-10">
    ...
    features: ['Installation', 'Réparation', 'Débouchage', 'Entretien']
  },
  {
    id: 4,
    title: 'Services généraux',
    description: 'Solutions complètes pour tous vos besoins de maintenance et d\'amélioration.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="currentColor" className="w-10 h-10">
    ...
    features: ['Électricité', 'Menuiserie', 'Serrurerie', 'Nettoyage']
  }
];
  ...
  return (
    <section id="services" className="py-20">
      <div className="container">
        <h2 className="text-3xl font-bold text-center mb-12">Nos <span className="text-primary">Services</span></h2>
          ...
          {services.map((service) => (
            ...
            >
              ...
              <div className="p-5">
                ...
                <div>
                  <h4 className="font-medium text-sm uppercase text-gray-500 mb-2">Services inclus</h4>
