  ...
  const services = [
    {
      ...
      featuresKey: 'services.renovation.features'
    },
    {
      id: 2,
      titleKey: 'services.shopfitting.title',
      descriptionKey: 'services.shopfitting.description',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="currentColor" className="w-10 h-10">
      ...
      featuresKey: 'services.shopfitting.features'
    },
    {
      id: 3,
    ...
    },
    {
      ...
      featuresKey: 'services.general.features'
    }
  ];
  ...
  return (
    <section id="services" className="py-24">
      <div className="container">
        <h2 className="text-3xl font-bold text-center mb-16">{t('services.title').toString().split(' ').map((word, index) => 
          ...
          {services.map((service) => (
            ...
            >
              <div className="relative h-48 w-full">
                <Image
                  src={service.image}
                  alt={t(service.titleKey).toString()}
                  fill
              ...
              <div className="p-6">
                ...
                <div>
                  <h4 className="font-medium text-sm uppercase text-gray-500 mb-3">{t('services.includedServices')}</h4>
                  <ul className="grid grid-cols-2 gap-2">
                    {(t(service.featuresKey) as string[]).map((feature, i) => (
